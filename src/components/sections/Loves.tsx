  ...
  return (
    <div className="max-w-xl">
      <button
        ...
        aria-label={flipped ? "Close the magazine" : "Open the magazine"}
      ...
      >
        ...
        >
          <div
            className="absolute inset-0 flex flex-col justify-between rounded-md bg-wine-deep p-6 text-left text-paper"
            style={{ backfaceVisibility: "hidden" }}
          >
            <p className="font-hand text-2xl text-rose">issue no. 01</p>
            <h3 className="font-display text-3xl leading-tight">
              Birthday &amp; Friendship Magazines
            </h3>
            <p className="text-sm text-rose">click to open →</p>
          </div>
          <div
            className="paper-card absolute inset-0 rounded-md p-6 text-left"
